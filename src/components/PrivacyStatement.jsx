  ...
  return (
    <section>
      <div className="mt-20 mb-20">
        <p className={`${styles.sectionSubText} `}><span className="text-[#13ab88]">{"<"}</span>Your privacy is our priority <span className="text-[#13ab88]">{"/>"}</span></p>
        <h2 className={`${styles.sectionHeadText}`}>Privacy Statement.</h2>
      </div>

      <div className="statement">
        <p>Last updated: October 13, 2024</p><br></br>
        ...
        <h2 className="text-[20px]">Interpretation and Definitions</h2><br />
        <h3 className="text-[18px]">Interpretation</h3>
        ...
        <h3 className="text-[18px]">Definitions</h3>
        <p>For the purposes of this Privacy Policy:</p>
        <ul className="indent-8 list-disc">
          <li>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Ben Waters Portfolio.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Ben Waters Portfolio, accessible from <a href="https://b-waters.com" rel="external nofollow noopener" target="_blank">https://b-waters.com</a></p>
          </li>
          <li>
            <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
          </li>
        </ul><br />
        <h2 className="text-[20px]">Collecting and Using Your Personal Data</h2><br />
        <h3 className="text-[18px]">Types of Data Collected</h3>
        <h4>Personal Data</h4>
        ...
        <h3 className="text-[18px]">Use of Your Personal Data</h3>
        ...
        <h3 className="text-[18px]">Transfer of Your Personal Data</h3>
        ...
        <h3 className="text-[18px]">Delete Your Personal Data</h3>
        ...
        <h3 className="text-[18px]">Disclosure of Your Personal Data</h3>
        ...
        <ul>
        <li>By email: contact@b-waters.com</li>
          </ul>
      </div>
    </section>
  );
...
export default SectionWrapper(PrivacyStatement, "");
